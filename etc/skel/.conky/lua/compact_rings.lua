...
{
    name='hwmon 1 temp 1',                    arg='',                  max_value=100,
    x=490,                          y=200,
    graph_radius=60,
    graph_thickness=20,
    ...
    caption_fg_colour=0xEF5A29,    caption_fg_alpha=0.5,
},
{
...
{
    name='fs_used_perc',                    arg='/media/usb0',                  max_value=100,
    x=490,                          y=510,
    graph_radius=40,
    graph_thickness=5,
